package com.irwanda.moviedb.utils;
...
public class BottomBarBehavior extends CoordinatorLayout.Behavior<BubbleNavigationLinearView> {
    ...
    //  nested scroll is when we scroll inside scroll view
    @Override
    ...
    // trigger when we slide/scroll up the screen
    private void slideUp(BubbleNavigationLinearView child) {
        child.clearAnimation();
        child.animate().translationY(0).setDuration(200);
    }

    // trigger when we slide/scroll down the screen
